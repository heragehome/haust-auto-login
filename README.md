...
| 1.0.1 | 2026-09-01 | 修复“黑框闪退无日志”：.ps1 补 UTF-8 BOM、新增 4 个双击即用 .bat 启动器 |
| 1.0.2 | 2026-09-01 | 修复 Write-Log 位置参数 bug；Load-Config 多候选路径 + 目录清单自诊断；新增 ⑤ 解除锁定.bat |
| 1.0.3 | 2026-09-01 | 显式加载 System.Net.Http；修复日志轮转与 Rename-Item 路径 bug |
| 1.0.4 | 2026-09-01 | **修复“code=,msg=”空报错**：CSRF Token 绑定 TCP 连接，全程复用同一 HttpClient |
| v2.0 | 2026-09 | 正式发布 大学掌（POST）版本，本 README 校准为真实用法 |
